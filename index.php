...
<head>
  <title>FoodFarm - Grocery Store HTML Website Template</title>
  <meta charset="utf-8">
...
<body>
  ...
  <?php require("./src/components/mobile-nav.php") ?>
  <?php require("./src/components/header.php") ?>
  <?php require("./src/components/slide.php") ?>
  <?php require("./src/components/main.php") ?>
  <?php require("./src/components/recent-blog.php") ?>
  <?php require("./src/components/subscribe.php") ?>
  <?php require("./src/components/delivery.php") ?>
