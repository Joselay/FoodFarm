        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="flex h-16 items-center">
            ...
            <div class="ml-auto flex items-center">
              <?php
              if (!($userData)) {
                echo '<div class="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                <a href="./views/signin.php" class="text-sm font-medium text-gray-700 hover:text-green-500">Sign in</a>
                <span class="h-6 w-px bg-gray-200" aria-hidden="true"></span>
                <a href="./views/signup.php" class="text-sm font-medium text-gray-700 hover:text-green-500">Create account</a>
              </div>';
              }
              ?>
              ...
              <div class="hidden lg:ml-8 lg:flex">
                <form method="POST" action="index.php">
                  ...
                  <button type="submit" class="flex items-center text-gray-700 hover:text-gray-800">
                    <img src="./public/images/<?php echo $_SESSION['language'] === Language::Khmer->value ? 'khmer.webp' : 'english.svg'; ?>" class="w-8 h-6" alt="">
              ...
              <?php if ($userData) : ?>
                <div class="relative ml-6 cursor-pointer text-sm group" id="user-menu-button">
                  ...
                  <div id="menu" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                    <a href="./views/profile.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-zinc-50" role="menuitem" tabindex="-1" id="user-menu-item-0">
                      <?= $translations['your_profile']; ?>
                    </a>
                    <a href="./views/orders.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-zinc-50" role="menuitem" tabindex="-1" id="user-menu-item-1"> <?= $translations['your_orders']; ?>
                    </a>
                    <a href="./views/signout.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-zinc-50" role="menuitem" tabindex="-1" id="user-menu-item-2"> <?= $translations['sign_out']; ?>
                    </a>
                  </div>
