...
<head>
  ...
  <title>FoodFarm | Admin Dashboard</title>
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div class="hidden sm:mb-8 sm:flex sm:justify-center">
          <div
            ...
            <a href="#" class="font-semibold text-green-600"><span class="absolute inset-0" aria-hidden="true"></span>Read
        ...
        <div class="text-center">
          <h1
            ...
            Manage Your FoodFarm with Ease
          </h1>
          <p class="mt-6 text-lg leading-8 text-gray-600">
            From product management to order tracking, streamline your operations efficiently using the FoodFarm Admin Dashboard.
          </p>
          <div class="mt-10 flex items-center justify-center gap-x-6">
            <a
              href="#"
              class="rounded-md bg-green-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Get started</a>
